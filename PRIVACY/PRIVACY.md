...
>
> **Falsifier class for ENGINE wire**: membership inference accuracy > random baseline + 5pp → 학습 흔적 식별 가능
> **Anticipated ENGINE behavior wire**: MI-aware DP-SGD scheduling · membership-leakage gated output
