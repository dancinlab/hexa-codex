...
| D-010 | Eval lineage storage              | **DuckDB** (sister-pattern with hexa-codex's parity verifiers; HF datasets stays for corpus). Cheap to confirm at v0.2.0 entry. | 2026-05-11 |
