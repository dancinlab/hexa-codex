...
- [x] §refutation closed-by-recompute: Arditi 2024 (arXiv:2406.11717) "single direction mediates refusal" universality claim FALSIFIED HARDENED++ **class-universal** · **4 orthogonal refutation axes** all closed-by-recompute: (1) cross-α (cycle-14 · 10× range 0.5→5.0 all 0/20) · (2) cross-recipe (cycle-14 + cycle-15 · huihui pure ablation + Josiefied v1 + Josiefied v2 custom finetune all 0/20) · (3) sysprompt-induction failure (cycle-15 all 3 Qwen recipes 0/20 sysprompt induced · re-tooled-dormant hypothesis closed) · (4) **cross-family (cycle-15b · Llama-3.2-1B abliterated also 0/20 project-IN + 15% sysprompt below threshold · class-universal across Qwen2.5 + Llama-3.2 architectures**) + capability tax non-load-bearing (UNCENSORED B1 cycle-14d bidirectional NEUTRAL pure_cap + +25pp over_refusal_relief GAIN)
...
| refutation | `ENGINE/verdicts/b1_cycle14_alpha_recipe_hardened_verdict.txt` (cycle-14 cross-α + cross-recipe HARDENED) + `ENGINE/verdicts/b1_cycle15_injection_readout_verdict.txt` (cycle-15 3-recipe sysprompt-induction FAILURE · refusal capacity structurally removed) + `ENGINE/verdicts/b1_cycle15b_cross_family_llama_verdict.txt` (cycle-15b cross-family Llama-3.2-1B class-universal HARDENED) + `VERTICAL/UNCENSORED/verdicts/b1_cycle14d_capability_bidirectional_verdict.txt` (B1 bidirectional NEUTRAL pure_cap · GAIN relief · refutes tax-only narrative) | 🔴 FALSIFIED HARDENED++ class-universal (4 orthogonal axes) |
