...
- [ ] S1 — Neural Cellular Automata (NCA) 가 LLM token-by-token autoregression 과 동형 dynamical system 인지 closed-form 비교. 반증자: NCA 가 token-AR 의 정상 attractor 와 다른 class → bio-CA 와 LLM 분리.
