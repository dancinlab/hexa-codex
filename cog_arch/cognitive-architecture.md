...
Cerebral cortex  layers + grid-cell  hex +  neurotransmitter species — the  inevitability pattern of cognitive architecture
...
| Effect | Today (2026) | After HEXA-COG-ARCH |  basis |
|------|-------------|--------------|---------|
| Primary spec | current practice | **** (6 cortical layers) | 12=12, 4=4 auto-derived |
...
**One-line summary**:  perfect-number arithmetic (sigma=12, tau=4, phi=2, sopfr=5) determines every design parameter of the Ultimate Cognitive Architecture (HEXA-COG-ARCH) pattern. Hard-coding 0, number-theoretic derivation target 100%.
...
├─────────────────────────────────────────────────────────────────────┤
│  Primary spec   = 6 cortical layers   │
│  Channels       sigma = 12                                           │
│  Parallelism    tau = 4                                              │
│  Symmetry       phi = 2                                              │
...
Re-derive the primary spec 6 via (1) direct -family computation, (2) Fraction exact rational,
...
# -*- coding: utf-8 -*-
# =============================================================================
# §7 VERIFY — HEXA-COG-ARCH  honesty-check pattern (stdlib only, domain=cognitive-architecture)
# 10 subsections:
