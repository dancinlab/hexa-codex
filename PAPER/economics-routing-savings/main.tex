...
\textbf{Strategies.} Two strategies are compared on the same manifest:
...
Both strategies are run end-to-end; raw per-task TSV rows persist to
\texttt{.verdicts/economics-routing-savings/\{baseline,router\}.tsv}.
...
\midrule
$\Delta$ (router $-$ base) & $-0.218033$ & $+4\,015$ & $0$ & --- \\
\bottomrule
\end{tabular}
\end{table}
