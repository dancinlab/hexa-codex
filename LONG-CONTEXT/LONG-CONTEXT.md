...
>
> **Falsifier class for ENGINE wire**: 64k 이상에서 정확도가 4k 대비 50% 미만 drop → 효과적 context 좁음
> **Anticipated ENGINE behavior wire**: effective-context-window budget allocation · auto-chunking router
