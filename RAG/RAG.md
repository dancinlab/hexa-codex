...
>
> **Falsifier class for ENGINE wire**: retriever recall@5 < 50% OR LLM 의 retrieved context 무시 (citation rate < 30%)
> **Anticipated ENGINE behavior wire**: retriever-quality gated answer · citation-rate enforced decoding
